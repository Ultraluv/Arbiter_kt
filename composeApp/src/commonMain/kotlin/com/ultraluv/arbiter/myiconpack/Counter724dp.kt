...
public val MyIconPack.Counter724dp: ImageVector
    get() {
        if (_counter724dp != null) {
            return _counter724dp!!
        }
        _counter724dp = Builder(name = "Counter724dp", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF1f1f1f)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(78.0f, -310.0f)
                quadToRelative(2.0f, -5.0f, 2.0f, -9.0f)
                verticalLineToRelative(-9.0f)
                quadToRelative(0.0f, -29.0f, -20.5f, -50.5f)
                reflectiveQuadTo(530.0f, 280.0f)
                lineTo(360.0f, 280.0f)
                verticalLineToRelative(80.0f)
                horizontalLineToRelative(160.0f)
                lineToRelative(-80.0f, 320.0f)
                close()
...
private var _counter724dp: ImageVector? = null
