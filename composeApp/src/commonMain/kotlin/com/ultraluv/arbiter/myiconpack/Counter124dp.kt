...
public val MyIconPack.Counter124dp: ImageVector
    get() {
        if (_counter124dp != null) {
            return _counter124dp!!
        }
        _counter124dp = Builder(name = "Counter124dp", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF1f1f1f)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(460.0f, 680.0f)
                horizontalLineToRelative(80.0f)
                verticalLineToRelative(-400.0f)
                lineTo(380.0f, 280.0f)
...
private var _counter124dp: ImageVector? = null
